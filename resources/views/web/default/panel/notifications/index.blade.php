    ...
    <section>
        <div class="d-flex align-items-center justify-content-between ">
            ...
            <a href="/panel/notifications/mark-all-as-read"
                class="delete-action d-flex align-items-center cursor-pointer text-hover-primary"
        ...
        @if (!empty($notifications) and !$notifications->isEmpty())
            @foreach ($notifications as $notification)
                <div
                    class="notification-card rounded-sm panel-shadow bg-secondary-acadima py-15 py-lg-20 px-20 px-lg-40 mt-20">
                    <div class="row row-cols-1 row-cols-lg-3 align-items-center justify-content-between gap-3">
                        ...
                        <div class="mt-10 mt-lg-0 p-0 d-flex align-items-start g-3 mb-3">
                            ...
                            <div class="">
                                <h3 class="notification-title font-16 font-weight-bold text-dark">{{ $notification->title }}
                                </h3>
                                <span
