    ...
    <section class="mt-25">
        @if (!empty($sales) and !$sales->isEmpty())
            ...
            @foreach ($sales as $sale)
                ...
                @if (!empty($item))
                    @php
                        ...
                        $hasActiveWebinars = $item->bundleWebinars->contains(function ($bundleWebinars) {
                            return $bundleWebinars->webinar->status == 'active';
                        });
            ...
            return optional($bundleWebinar->webinar)->start_date ?? PHP_INT_MAX;
                                                ...
                                                @php
                                                    if ($bundleWebinar->webinar->status == 'active') {
                                                        $totalHours += $bundleWebinar->webinar->duration;
                                                    }
                                                @endphp

                                                @if (!empty($bundleWebinar->webinar->title) && $bundleWebinar->webinar->status == 'active')
                                                    <tr>
                                                        <td>{{ $loop->index + 1 }}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (!empty($bundleWebinar->webinar->assignments[0]))
                                                                <button
                                                                    ...
                                                                    disabled> {{trans('panel.tasks_available')}} </button>
                                                            @else
                                                                <button
                                                                    ...
                                                                    disabled>{{trans('panel.no_tasks_available')}}</button>
                                                            @endif
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                <button type="button"
                                                                    ...
                                                                    disabled>{{trans('panel.no_submissions')}}</button>
                                                            @endif
                                                        </td>
                        ...
                        @else
                            @include('admin.includes.no-result', [
                                ...
                                'title' => trans('panel.courses_not_started'),
                                'hint' => '',
                            ])
                        @endif
                    </section>
