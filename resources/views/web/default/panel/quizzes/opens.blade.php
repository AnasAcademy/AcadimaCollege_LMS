            ...
            <form action="/panel/quizzes/opens" method="get" class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label class="input-label text-black">{{ trans('public.from') }}</label>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label class="input-label text-black">{{ trans('public.to') }}</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="dateInputGroupPrepend">
                                            <i data-feather="calendar" width="18" height="18" class="text-light"></i>
                ...
                <div class="col-12 col-lg-6">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <label class="input-label text-black">{{ trans('quiz.quiz_or_webinar') }}</label>
                                <input type="text" name="quiz_or_webinar" class="form-control" value="{{ request()->get('quiz_or_webinar','') }}"/>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <label class="input-label text-black">{{ trans('public.instructor') }}</label>
                            ...
                            <table class="table custom-table">
                                ...
                                @foreach($quizzes as $quiz)
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <span class="d-block text-black font-weight-500">{{ $quiz->title }}</span>
                                            <span class="font-12 mt-5 text-black d-block">{{ $quiz->webinar->title }}</span>
                                        </td>
                                        <td class="text-black font-weight-500 align-middle">{{ $quiz->quizQuestions->sum('grade') }}</td>


                                        <td class="text-black font-weight-500 align-middle">{{ dateTimeFormat($quiz->created_at,'j M Y H:i')}}</td>
