...
@section('body')
    <td class="social-title pb-30"
        ...
        <div mc:edit="text_33" style="color: #333; direction: ltr !important; padding-right:20px;">
            ...
            <div class="alert alert-success text-light" style="font-family: cairo, sans-serif; direction: ltr !important; text-align: left; color: #000;">
                <p  role="alert">
