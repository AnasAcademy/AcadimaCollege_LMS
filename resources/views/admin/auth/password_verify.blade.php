...
@section('body')
    ...
    <td valign="top" class="social-title pb-30" mc:edit="body_content"
        ...
        <div class="container" style="color: #333; direction: ltr !important; padding:20px;">
            <div class="row justify-content-center ">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="alert alert-success text-light" role="alert" style="font-family: cairo, sans-serif; direction: ltr !important; text-align: right; color: #fff;">
