...
@section('content')
    ...
    <img src="{{ asset('store/Acadima/Acadima-Black.png') }}" alt="logo" width="100%" class="">
        ...
        <h4 class="font-20 font-weight-bold m-3 ltr" style="display: flex; align-items: center; gap: 8px;">
        ...
        <form method="POST" action="{{ getAdminPanelUrl() }}/reset-password">
            ...
            <div class="form-group ltr">
                ...
                <div class="border-radius-lg input-size form-control input-flex">
                    ...
                    <input type="email" name="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror border-none" id="email"
            ...
            <div class="form-group ltr">
                ...
                <div class="border-radius-lg input-size form-control input-flex">
                    ...
                    <input name="password" type="password" placeholder="Password"
                       class="form-control @error('password') is-invalid @enderror border-none" id="password"
            ...
            <div class="form-group ltr">
                ...
                <div class="border-radius-lg input-size form-control input-flex">
                    ...
                    <input name="password_confirmation" type="password" placeholder="Retype Password"
                       class="form-control @error('password_confirmation') is-invalid @enderror border-none" id="confirm_password"
